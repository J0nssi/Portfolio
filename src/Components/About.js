      ...
      <h1 className='header_about'>ABOUT</h1>
            ...
            <Fade right duration={750} delay={500} distance="30px">
              <div className="rightside_about">
                <p>It all started when I applied to Savonia UAS in 2019 and got into my Bachelor of Engineering, Information Technology studies. Three years later I'm near the finish line with my studies.  
                </p>
                <br/>
